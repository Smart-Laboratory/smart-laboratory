...
$(function() {
	...
	$("#printBtn").click(function(){
		...
		$("#samplePrintFrame").append("<iframe id='iframe_sample' name='iframe_sample' frameborder=0 style='background-color:transparent' width='99%' height='99%' src=\"<c:url value='/explain/audit/samplePrint'/>\" />");
		$("#print").dialog("open");
...
<div>
	...
	<div class="row clearfix">
		...
		<ul class="nav nav-pills">
			...
			<li><a href="<c:url value='/critical/dealed' />"><span style="font-size:18px;"><fmt:message key='audit.info.dangerous.deal' /></span></a></li>
			<li><a id="printBtn"><span style="font-size:18px;"><fmt:message key="audit.print" /></span></a></li>
		</ul>
		</div>
	</div>
	</div>
