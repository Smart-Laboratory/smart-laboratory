...
<html>
	<div style="float:left;width:96%;margin-left:10px;margin-top:5px;">
		<div style="height:40px;width:100%;">
			<img src="../images/zy_logo.png" style="float:left;margin-left:15%;"/>
			<b style="float:left;font-size:10px;margin-top:20px;margin-left:5%">No:${sampleNo}</b>
		</div>
	...
	<div id="resultDiv" style="float:left;width:92%;margin-left:10px;margin-top:2px;font-size:12px;height:650px;border-top:1px solid #000000;">
		<div style="height:20px;margin-left:10px;width:100%;"><b>
			<div style="float:left;width:5%;">No.</div>
			<div style="float:left;width:35%;"><fmt:message key="project"/></div>
			<div style="float:left;width:15%;"><fmt:message key="sample.print.result"/></div>
			<div style="float:left;width:15%;" id="hisTitle1">&nbsp;</div>
	...
	<div style="float:left;width:92%;margin-left:10px;margin-top:2px;font-size:12px;height:50px;">
		<div style="float:left;width:10%;margin-left:10px;"><b><fmt:message key="sample.diagadvise"/>:</b></div>
	</div>
	<div style="float:left;width:92%;margin-left:10px;margin-top:2px;font-size:12px;height:40px;border-top:1px solid #000000;">
		<div style="height:20px;margin-left:10px;width:100%;">
	...
	<div style="float:left;width:92%;margin-top:2px;font-size:10px;text-align:center;margin-left:20px;"><fmt:message key="sample.print.note"/></div>
