...
<form:hidden path="examinaim"/>
<form:hidden path="labDepartment"/>
<form:hidden path="receivePerson"/>
<form:hidden path="receiveTime"/>
<form:hidden path="sampleNo"/>
<form:hidden path="treatmentType"/>
...
<div class="clearfix">
	<div id="patient-info" class="alert alert-info" style="margin-bottom:2px;padding:0px;padding-left:10px;padding-bottom:4px;">
		...
		<div class="pItem">
			...
			<span class="pText"><b><c:out value="${invalidSamples.receivePerson}"/></b></span>

			<span class="pLabel" style="margin-left:20px;"><fmt:message key="patients.sampleType"/></span>
			<span class="pText"><b><c:out value="${invalidSamples.sampleTypeString}"/></b></span>

			<span class="pLabel" style="margin-left:20px;"><fmt:message key="patients.labDepartment"/></span>
			<span class="pText"><b><c:out value="${invalidSamples.labDepartmentStr}"/></b></span>
		</div>
		
		<div class="pItem">
			<span class="pLabel"><fmt:message key="patients.receiveTime"/></span>
			<span class="pText"><b><c:out value="${invalidSamples.receiveTime}"/></b></span>
...
<table class="table">
	<tr height="60">
    	...
    	<form:select path="rejectSampleReason">
    		...
    		<form:option value="20"><fmt:message key="sampleReason.20"/></form:option>
...
<ul>
    <li>
        ...
        <input type="button" class="btn" name="delete" onclick="button('d');submit()"
