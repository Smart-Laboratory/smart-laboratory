...
public class TestCaseController {
    ...
    public DataResponse getList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        int size = 0;
        size = testCaseManager.getTestCaseCount(query,start,end,sidx,sord);
        ...
        list = testCaseManager.getTestCaseList(query,start,end,sidx,sord);
        List<Map<String, Object>> dataRows = new ArrayList<Map<String, Object>>();
        for(TestCase info :list) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("id", ConvertUtil.null2String(info.getId()));
            map.put("name", ConvertUtil.null2String(info.getTestId()));
