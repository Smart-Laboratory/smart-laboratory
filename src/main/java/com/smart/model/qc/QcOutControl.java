 ...
 */
@Entity
@Table(name = "l_qc_outcontrol")
public class QcOutControl {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_QC_OUT")
	@SequenceGenerator(name="SEQ_QC_OUT", sequenceName = "qc_out_sequence", allocationSize = 1)
	public Long getId() {
		return id;
	}
