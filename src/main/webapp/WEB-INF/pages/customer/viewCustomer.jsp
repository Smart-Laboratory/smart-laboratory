        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <%--<div class="widget-toolbar no-border">--%>
                    <%--<button class="btn btn-xs btn-info" onclick="save()" style="z-index: 99">--%>
...
<script type="text/javascript">
    ...
    function Add(){
        layer.open({
            ...
            shade:0.5,
            title: "添加客户信息",
            content:  '../customer/ajaxcustomerRelation?method=addNewCustomer'
        })
    }
    function Edit(){
        ...
        layer.open({
            ...
            shade:0.5,
            title: "添加客户信息",
            content:  '../customer/ajaxcustomerRelation?method=editCustomer&customerid='+rowData.customerid
        })
    }
    ...
    function initContactGrid() {
        ...
        $("#tableList").jqGrid({
            caption: "设置",
            datatype: "json",
            colNames: ['customerid', '联系人ID', '名称', '年龄', '性别', '职位', '爱好', '生日', '工作电话', '家庭电话', '手机', '对公司态度', '最佳拜访时间', '最佳拜访地点', '最佳拜访路线', '婚姻状况', '配偶姓名', '配偶职业', '配偶爱好', '备注'],
            colModel: [
                ...
                {name: 'maritalstatus', index: 'maritalstatus', width: 120,},
    ...
    function addNewContact(){
        ...
        layer.open({
            ...
            shade:0.5,
            title: "添加客户信息",
            content:  '../customer/ajaxcustomerRelation?method=addNewContact&customerid='+rowData.customerid
        })
    }
    ...
    function editContact(){
        ...
        layer.open({
            ...
            shade:0.5,
            title: "添加客户信息",
            content:  '../customer/ajaxcustomerRelation?method=editContact&serialnumber='+contactRowData.serialnumber+"&customerid="+rowData.customerid
        })
    }
    function deleteContact (){
        ...
        layer.confirm('确定删除选择数据？', {icon: 2, title:'警告'}, function(index){
            $.post('../customer/deleteCustomer',{id:rowData.customerid,serialnumber:rowData.serialnumber,method:"deleteContact"},function(data) {
                if (jQuery.parseJSON(data).result == 'success'){
                    layer.msg("数据删除成功", {icon: 1, time: 1000});
